	...
	@for ($i = 0; $i < count($posts); $i++)
		...
		<div class="item">
			...
			<div class="info">
				...
				<div class="actions">
					<div class="view-more">
						<a class="button primary" href="/evento/{{ $post->slug }}">Ver más</a>
					</div>

					<div class="button">
						<a class="social-share facebook tooltipped" 
							href="http://www.facebook.com/sharer.php?u={{Request::root()}}/evento/{{ $post->slug }}"
				        ...
				        <a class="social-share twitter tooltipped" 
							href="https://twitter.com/share?url={{Request::root()}}/evento/{{ $post->slug }}"
