...
@section('title', 'Todos los formularios - Admin Amolca')
...
@section('scripts')
<script src="{{ asset('js/admin/forms/forms.js') }}"></script>
...
@section('contentClass', 'all-forms')
@section('content')
	...
	<table class="table data-table forms">
		<thead>
			<tr>
				<th class="id">ID.</th>
				<th class="from">Enviado por:</th>
				<th class="date">Fecha:</th>
				<th class="to">Receptor:</th>
