...
class IntranetCatalogs extends GuzzleHttpRequest {

	public function all($params = 'limit=3000') {
        return $this->get("intranet/catalogs");
	}
	...
	public function medician() {
		return $this->get("intranet/catalogs/medician");
	}

	public function odontology() {
		return $this->get("intranet/catalogs/odontology");
	}
